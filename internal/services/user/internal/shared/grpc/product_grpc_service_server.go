...
import (
	...
	createProductCommandV1 "github.com/reoden/go-NFT/user/internal/user/features/creatingproduct/v1"
	createProductDtosV1 "github.com/reoden/go-NFT/user/internal/user/features/creatingproduct/v1/dtos"
	getProductByIdQueryV1 "github.com/reoden/go-NFT/user/internal/user/features/gettingproductbyid/v1"
	getProductByIdDtosV1 "github.com/reoden/go-NFT/user/internal/user/features/gettingproductbyid/v1/dtos"
	updateProductCommandV1 "github.com/reoden/go-NFT/user/internal/user/features/updatingproduct/v1"
...
type ProductGrpcServiceServer struct {
	catalogsMetrics *contracts.UserMetrics
