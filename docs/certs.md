...
```
Country Nickname (2 letter code) []:US
State or Province Nickname (full name) []:CA
Locality Nickname (eg, city) []:Riverside
Organization Nickname (eg, company) []:Sumo
Organizational Unit Nickname (eg, section) []:Demo
Common Nickname (eg, fully qualified host name) []:*
